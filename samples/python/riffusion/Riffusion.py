...
TEXT_ENCODER_MODEL_LINK     = MODEL_NAME + "_quantized/v1/text_encoder.serialized.bin"
UNET_MODEL_LINK             = MODEL_NAME + "_quantized/v1/unet.serialized.bin"
VAE_DECODER_MODEL_LINK      = MODEL_NAME + "_quantized/v1/vae_decoder.serialized.bin"
