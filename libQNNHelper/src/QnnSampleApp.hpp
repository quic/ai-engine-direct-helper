...
#include "BackendExtensions/QnnConfig.hpp"
#include "BackendExtensions/IBackend.hpp"
#include "BackendExtensions/BackendExtensions.hpp"
...
// zw.
  ...
  StatusCode initializeBackendExtensions(BackendExtensionsConfigs backendExtensionsConfig);
  StatusCode initializePerformance();
  StatusCode destroyPerformance();
  StatusCode boostPerformance();
  StatusCode resetPerformance();
