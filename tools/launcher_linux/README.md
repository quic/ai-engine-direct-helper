...
1. Download the compressed package through [QAI_Launcher_Linux_v2.0.0.zip](https://github.com/quic/ai-engine-direct-helper/releases/download/v2.38.0/QAI_Launcher_Linux_v2.0.0.zip)  and reduce the compression; <br>
