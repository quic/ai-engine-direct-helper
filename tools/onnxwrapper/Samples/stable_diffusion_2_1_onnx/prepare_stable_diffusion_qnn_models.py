...
# ---------------------------------------------------------------------
# Download Stable Diffusion 2.1 QNN model assets into ./models-qnn
#
# Directory layout:
# models-qnn/
...
# AI Hub model IDs
MODEL_ID_TEXT_ENCODER = "mq3p9dd6n"
MODEL_ID_UNET = "mmd46dywm"
MODEL_ID_VAE_DECODER = "mn03orx8n"

# QNN binary filenames
TEXT_ENCODER_MODEL_NAME = (
    MODEL_NAME + "_quantized-textencoderquantizable-qualcomm_snapdragon_x_elite.bin"
)
UNET_MODEL_NAME = (
    MODEL_NAME + "_quantized-unetquantizable-qualcomm_snapdragon_x_elite.bin"
)
VAE_DECODER_MODEL_NAME = (
    MODEL_NAME + "_quantized-vaedecoderquantizable-qualcomm_snapdragon_x_elite.bin"
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Download Stable Diffusion 2.1 QNN models into ./models-qnn"
    )
