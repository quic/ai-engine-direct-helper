...
$scriptBlock = {
    ...
    $userProfilePath = $env:USERPROFILE
    pushd "..\code\qualcomm\ai-engine-direct-helper\samples";& "..\..\..\myenvs\clean-py3.12\Scripts\Activate.ps1";python genie\python\GenieAPIService.py > "..\..\GenieWebUI\log\$logFileName"  2>&1
}
