...
Function Download_Genie_Helper {
    ...
    process {
        ...
        $qai_libs_cache_path = "..\cache\qualcomm\$qai_libs_zip"
        $qai_appbuilder_cache_path = "..\cache\qualcomm\$qai_appbuilder_whl"
        ...
        $phiTokenFile = "$PSScriptRoot\..\..\..\tools\langflow\cache\phi_3_5_mini_instruct_quantized\tokenizer.json"
        $ibmTokenFile = "$PSScriptRoot\..\..\..\tools\langflow\cache\ibm_granite_v3_1_8b_instruct_quantized\tokenizer.json"
        Invoke-WebRequest -Uri "https://gitee.com/hf-models/Phi-3.5-mini-instruct/raw/main/tokenizer.json" -OutFile $phiTokenFile -ErrorAction Stop
        Invoke-WebRequest -Uri "https://gitee.com/hf-models/granite-3.1-8b-base/raw/main/tokenizer.json" -OutFile $ibmTokenFile -ErrorAction Stop
    }
}
